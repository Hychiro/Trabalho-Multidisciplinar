...
class PorositiyProblem():
    def __init__(self):
        ...
        self.volW__ = 110.893 # volume de agua dentro do experimento (resultado da massaFinal - massaInicial do experimento)
    ...
    def settingEnviroment(self):
        ...
        self.timeT = 20 #tempo total para o deslocamento
    ...
    def calculate(self):
        ...
        D = 2.299e-9 # constante de difussão da agua à 25º é 2.299·10−9 m2·s−1
